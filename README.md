...
# Hi, here i've implemented Web scraping script to get Eth value from CoinMarketCap site

## A little more info:

+ Script supports continuous working without internet connection(Retry every one minute);
+ Data is writting to .csv file every 5 minutes as refresh time on site is 5 it;
